...
export class OnsetDetector {
  ...
  private f1 = { flux: 0, thr: 0, t: 0 }; // n-2
  private f2 = { flux: 0, thr: 0, t: 0 }; // n-1
  private count = 0;
  ...
  /** Feed one magnitude spectrum with its frame time (ms). Returns an onset if
   *  the *previous* frame is now confirmed as a peak. */
  process(mag: Float32Array, tMs: number): OnsetEvent | null {
